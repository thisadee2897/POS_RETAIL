...
const ShiftSetting = () => {
    ...
    const columnData = [
        ...
        {
            name: 'สถานะ',
            selector: row => <Switchstatus value={row.master_shift_job_active} />,
            sortable: true,
        },
        {
            name: 'แก้ไข',
    ...
    const columnDialog = [
        { name: 'รอบการขาย', type: "input_text", key: "master_shift_job_name", validate: true },
        { name: 'หมายเหตุ', type: "input_text", key: "master_shift_job_remark" },
        { name: 'รอบการขายสุดท้ายของวัน', type: "switch_status", key: "master_shift_job_last_day_active" },
        { name: 'สถานะการใช้งาน', type: "switch_status", key: "master_shift_job_active" }
    ]
